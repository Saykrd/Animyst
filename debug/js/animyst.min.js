...
Animyst.Application = function() {
    this._appStateList = [], this._appStateLib = {};
    ...
    paper.setup(a.canvasID), view.onFrame = this.update.bind(this)), console.log("[Application] Application Started");
...
Main.prototype = {
    start: function() {
        ...
        var a = new Animyst.Application();
        a.startup({
            paper: !0,
            canvasID: "game"
        });
        var b = new Game("game1");
        a.run(b);
    }
