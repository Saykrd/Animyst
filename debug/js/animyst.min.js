...
Animyst.Application = function() {
    this._appStateList = [], this._appStateLib = {}, this._stats = null;
}, Animyst.Application.prototype.startup = function(a) {
    console.log("==================================================="), console.log("   ----- AnimystJS: (v 0.0.0) by ~Saykrd -----   "), 
    console.log("==================================================="), a.paper && (paper.install(window), 
    paper.setup(a.canvasID), view.onFrame = this.update.bind(this)), a.debug && (this._stats = new Stats(), 
...
Animyst.Sound.prototype = Object.create(Animyst.System.prototype), Animyst.Sound.prototype.startup = function(a) {
    ...
    b.play(), Animyst.System.prototype.startup.call(this, a);
