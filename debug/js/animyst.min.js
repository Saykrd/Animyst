...
Animyst.Application = function() {
    ...
    this.initSignal = new signals.Signal(), this.config = null;
}, Animyst.Application.prototype.startup = function(a) {
    console.log("==================================================="), console.log("   ----- AnimystJS: (v 0.0.0) by ~Saykrd -----   "), 
    console.log("==================================================="), this._startParams = a, 
    ...
    if (a == Animyst.DataLoad.FILE_LOADED) switch (b.item.id) {
      case "config":
        console.log("[Application] Config json loaded"), console.log(Animyst.DataLoad.getAsset("config")), 
        this.config = Animyst.DataLoad.getAsset("config"), Animyst.DataLoad.loadFromManifest([ {
            id: "assets",
      ...
      case "assets":
        ...
        Animyst.DataLoad.listAssets(c.manifest), console.log(Animyst.DataLoad._assetList), 
    ...
    function a() {
        ...
        var a, d, e, f;
        e = document.body.clientWidth, f = document.body.clientHeight, "noBorder" == b.scaleMode ? (a = e > b.minWidth ? e : b.minWidth, 
        d = f > b.minHeight ? f : b.minHeight) : (a = b.minWidth || 0, d = b.minHeight || 0), 
        c.width = a, c.height = d;
    }
    this._startParams;
    if (this.config.settings.canvasSettings) {
        var b = this.config.settings.canvasSettings;
        switch (b.type) {
          case "paper":
            paper.install(window);
            var c = document.createElement("canvas");
            c.id = "paper", document.body.appendChild(c), a(), Animyst.Window.resizeSignal.add(a), 
            paper.setup(c);
        }
    ...
    document.body.appendChild(this._stats.domElement), console.log("[Application] Stats Enabled")), 
    console.log("[Application] Application Started"), this.initSignal.dispatch();
    ...
    this.stop(), this._systemList = null, this._systemLib = null;
...
Animyst.DataLoad.FILE_LOADED = 7, Animyst.DataLoad.FILE_ERROR = 8, Animyst.DataLoad.startup = function(a) {
    ...
    console.log("[DataLoad] Loading File:", a.item.id, "from:", a.item.src);
    var b = Animyst.DataLoad._loadSignal;
    ...
    console.log("[DataLoad] File Loaded:", a.item.id, "from:", a.item.src);
    var b = Animyst.DataLoad._loadSignal;
...
Animyst.Window._onResize = function(a) {
    console.log("[Window] onResize!"), Animyst.Window.resizeSignal.dispatch(a);
...
Animyst.Input.prototype.startup = function(a) {
    ...
    console.log("[Input] Touch Start!"), this.handleTouchInput(Animyst.Input.TOUCH_START, a);
}, Animyst.Input.prototype.onTouchMove = function(a) {
    console.log("[Input] Touch Move!"), this.handleTouchInput(Animyst.Input.TOUCH_MOVE, a);
}, Animyst.Input.prototype.onTouchRelease = function(a) {
    console.log("[Input] Touch Release!"), this.handleTouchInput(Animyst.Input.TOUCH_RELEASE, a);
}, Animyst.Input.prototype.onTouchEnter = function(a) {
    console.log("[Input] Touch Enter!"), this.handleTouchInput(Animyst.Input.TOUCH_ENTER, a);
}, Animyst.Input.prototype.onTouchLeave = function(a) {
    console.log("[Input] Touch Leave!"), this.handleTouchInput(Animyst.Input.TOUCH_LEAVE, a);
}, Animyst.Input.prototype.onClick = function(a) {
    console.log("[Input] Mouse Click!"), this.handleMouseInput(Animyst.Input.MOUSE_CLICK, a);
}, Animyst.Input.prototype.onMouseDown = function(a) {
    console.log("[Input] Mouse Down!"), this.handleMouseInput(Animyst.Input.MOUSE_DOWN, a);
}, Animyst.Input.prototype.onMouseDrag = function(a) {
    console.log("[Input] Mouse Drag!"), this.handleMouseInput(Animyst.Input.MOUSE_DRAG, a);
}, Animyst.Input.prototype.onMouseMove = function(a) {
    console.log("[Input] Mouse Move!"), this.handleMouseInput(Animyst.Input.MOUSE_MOVE, a);
}, Animyst.Input.prototype.onMouseUp = function(a) {
    console.log("[Input] Mouse Up!"), this.handleMouseInput(Animyst.Input.MOUSE_UP, a);
}, Animyst.Input.prototype.onMouseEnter = function(a) {
    console.log("[Input] Mouse Enter!"), this.handleMouseInput(Animyst.Input.MOUSE_ENTER, a);
}, Animyst.Input.prototype.onMouseLeave = function(a) {
    console.log("[Input] Mouse Leave!"), this.handleMouseInput(Animyst.Input.MOUSE_LEAVE, a);
}, Animyst.Input.prototype.onKeyUp = function(a) {
    console.log("[Animyst.Input] Released Key:", a.key), a.preventDefault(), this.handleKeyInput(Animyst.Input.KEY_UP, a);
}, Animyst.Input.prototype.onKeyDown = function(a) {
    console.log("[Animyst.Input] Pressed Key:", a.key), a.preventDefault(), this.handleKeyInput(Animyst.Input.KEY_DOWN, a);
    ...
    this.inputData.setKeyInput(a == Animyst.Input.KEY_DOWN, b.key);
...
Animyst.InputData.prototype.clear = function() {
    ...
    return this.map[a] && this.map[a].active;
    ...
    d && (console.log("[InputData] Click Start!"), this.mouse.clickStart = d, this.mouse.clickTime = 0, 
    e = Animyst.InputData.MOUSE_DOWN), c && (console.log("[InputData] Click Ended!", this.mouse.clickTime), 
    ...
    for (var b = 0; b < a.length; b++) {
        ...
        if (d) {
            ...
            this.touches.push(f), this.totalTouchCount++, console.log("[InputData] Adding Touch:", f.uid), 
    ...
    for (var b = this.touches.length - 1; b > -1 && this.touches.length > 0; b--) {
        ...
        d && (console.log("[InputData] Removing Touch:", c.uid), this.touchHistory.shift(c), 
    ...
    for (var b = 0; b < a.length; b++) {
        ...
        if (c) {
            ...
            console.log("[InputData] Updated Touch:", c.uid, Math.round(c.pageX), Math.round(c.pageY), Math.round(c.screenX), Math.round(c.screenY), c.force || c.webkitForce), 
