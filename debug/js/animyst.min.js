...
Animyst.LOGGING = !0, Animyst.Application = function() {
    ...
    this._startParams;
    if (Animyst.LOGGING = this.config.settings.logging, this.config.settings.canvasSettings) {
...
Animyst.Window.width = 0, Animyst.Window.height = 0, Animyst.Window._onResize = function(a) {
    console.log("[Window] onResize!"), Animyst.Window.width = document.body.clientWidth, 
