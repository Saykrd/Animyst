/*! animyst 2015-11-01 */
Game = function(a) {
    Animyst.AppState.call(this, a), this.inputData = null, this.gameData = null, this.viewport = null;
    ...
    this.viewport = new Animyst.Viewport3D(a, Animyst.Window.width, Animyst.Window.height), 
    this.viewport.initDisplay({
        resize: !0,
        debugControls: !0,
        addAxis: !0
    ...
    Animyst.AppState.prototype.update.call(this, a, b), this.viewport.render();
...
GameDisplay.prototype.startup = function(a) {
...
}, GameDisplay.prototype.update = function(a, b) {
...
}, GameDisplay.prototype.createGraphic = function(a) {
    ...
    Animyst.System.prototype.shutdown.call(this);
}, GameLogic.prototype.update = function(a, b) {
...
}, Animyst.InputDisplay.prototype.update = function(a, b) {}, Animyst.InputDisplay.prototype.inputHandler = function(a, b, c) {
    switch (a) {
      case Animyst.InputData.MOUSE:
        this.mouse || (this.mouse = new Shape.Circle({
            ...
            fillColor: "#00FFFF",
            opacity: .5
        }), this.layer.addChild(this.mouse)), this.mouse.position = c.point, c.down ? this.mouse.fillColor = "#FF0000" : this.mouse.fillColor = "#00FFFF";
        break;
