...
Game = function(a) {
    ...
    this.inputData = new Animyst.InputData(), this.gameData = new GameData();
    var a = new GameLogic(this.gameData, this.inputData), b = new GameDisplay(this.gameData), c = new Animyst.Input(this.inputData);
    c.startup({
        tool: new Tool(),
        element: document.getElementById("game")
    }), b.startup(), a.startup(), this.addSystem("input", c), this.addSystem("gameLogic", a);
...
GameDisplay.prototype.startup = function(a) {
    this.gameData.signal.add(this.entityHandler, this), this.layer = new Layer({
        position: new Point()
