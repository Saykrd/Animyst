...
Animyst.Application = function() {
    ...
    var a = this._startParams;
    a.paper && (paper.install(window), a.canvasID ? paper.setup(a.canvasID) : console.error("[Application] ! No canvas ID specified. Cant Setup PaperJS."), 
    view.onFrame = this.update.bind(this)), a.debug && window.Stats && (this._stats = new Stats(), 
    ...
    console.log("[Application] Stats Enabled")), console.log("[Application] Application Started"), 
...
Animyst.DataLoad.FILE_LOADED = 7, Animyst.DataLoad.FILE_ERROR = 8, Animyst.DataLoad.startup = function(a) {
    ...
    this.started = !1;
}, Animyst.System.prototype.update = function() {}, !function() {
...
"object" == typeof module && (module.exports = Stats), Animyst.Sound = function() {}, 
Animyst.Sound.prototype = Object.create(Animyst.System.prototype), Animyst.Sound.prototype.startup = function(a) {
